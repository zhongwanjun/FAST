...
class MrpcProcessor(DataProcessor):
    ...
    def get_train_examples(self, data_dir, train_file='realnews_train.tsv'):
        """See base class."""
    ...
    def get_dev_examples(self, data_dir, dev_file='realnews_dev.tsv'):
        """See base class."""
        return self._create_examples(self._read_tsv(os.path.join(data_dir, dev_file)), "val")

    def get_test_examples(self, data_dir, test_file='realnews_test.tsv'):
        """See base class."""
...
class DeepFakeProcessor(DataProcessor):
    ...
    def get_train_examples(self, data_dir,train_file='p=1.00.jsonl'):
        """See base class."""
        logger.info("LOOKING AT {}".format(os.path.join(data_dir, train_file)))
        return self._create_examples(self._read_jsonl(os.path.join(data_dir,train_file)), "train")

    def get_dev_examples(self, data_dir,dev_file='p=1.00.jsonl'):
        """See base class."""
        return self._create_examples(self._read_jsonl(os.path.join(data_dir,dev_file)), "val")

    def get_test_examples(self, data_dir,test_file='p=1.00.jsonl'):
        """See base class."""
